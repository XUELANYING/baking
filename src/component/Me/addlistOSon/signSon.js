...
import  "@asset/css/nest/Me/SignSon.scss"
//亮点 快乐大转盘
//创建人：郭郭
//时间：8月3日
//下方数据渲染
...
class SignSon extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            awards: [
                {id: 1, name: '一等奖', level: '1', color:"#FF8A6D"},
                {id: 2, name: '二等奖', level: '2', color:"#FFE122"},
                {id: 3, name: '三等奖', level: '3', color:"#FF8A6D"},
                {id: 4, name: '四等奖', level: '4', color:"#FFE122"},
                {id: 5, name: '五等奖', level: '5', color:"#FF8A6D"},
                {id: 6, name: '六等奖', level: '6', color:"#FFE122"},
                {id: 7, name: '七等奖', level: '7', color:"#FF8A6D"},
                {id: 8, name: '八等奖', level: '8', color:"#FFC200"},
                {id: 9, name: '终极大奖', level: '9', color:"#f13f40"},
            ],//大转盘的奖品列表
            animation: true,
    ...
    distanceToStop() {
        ...
        this.setState({
            index: '当前奖品应该中的奖品是：' + this.state.awards[currentPrizeIndex].name
        },()=>{
             // console.log(this.state.index)
        })
            Toast.info('当前奖品应该中的奖品是' + this.state.awards[currentPrizeIndex].name,3)
    ...
    render(){
        ...
        return <div className="wheel-container">
            <div className="wheel-main">
                <div className="wheel">
                    <img className="wheel-circle" src="https://image.hongbeibang.com/FlijP6iuVJ9gjxSWsdOcklE9TYmr?750X750&imageView2/1/w/500/h/500"/>
